...
export class NewsCreateComponent implements OnInit{
    ...
    onSaveNews(){
        ...
        this.isLoading = true;
        if(this.mode === 'create'){
            this.newsService.addNews(this.form.value.category, this.form.value.content, this.form.value.image);
        }else{
            this.newsService.updateNews(this.newsId,this.form.value.category, this.form.value.content, this.form.value.image)
        }
